    ...
    <section id="Planos" className="py-16 px-4 sm:px-6 lg:px-8 scroll-mt-24">
      <div className="max-w-7xl mx-auto">
          ...
          {loading
            ...
            : plans.map((plan) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => setSelectedInterest({ type: 'service', id: `plano-${plan.id}`, label: `Plano ${plan.name}` })}
        ...
        <p className="mt-6 text-center text-xs text-slate-400 dark:text-white/40">
          Os planos são ajustados conforme o escopo do seu projeto.
        </p>
      </div>
