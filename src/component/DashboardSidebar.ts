      ...
      <div className="flex-col min-h-full px-0 flex flex-wrap items-center justify-between w-full mx-auto overflow-y-auto overflow-x-hidden">
        <div className="flex bg-transparent flex-col items-stretch opacity-100 relative mt-4 overflow-y-auto overflow-x-hidden h-auto z-40 items-center flex-1 rounded-2xl w-full">
          ...
          <div className="md:flex-col md:min-w-full flex flex-col list-none mt-8 gap-2">
            ...
            <Link href="/dashboard" className="flex items-center gap-3 text-sm uppercase py-3 px-4 font-bold rounded-xl transition-all duration-200 text-white hover:bg-blue-800/80 dark:hover:bg-gray-700">
              <FiHome className="w-5 h-5" />
              Dashboard
            </Link>
            <Link href="/dashboard/projeto" className="flex items-center gap-3 text-sm uppercase py-3 px-4 font-bold rounded-xl transition-all duration-200 text-white hover:bg-blue-800/80 dark:hover:bg-gray-700">
              <FiFolder className="w-5 h-5" />
              Seu Projeto
            </Link>
            <Link href="/dashboard/planejamento" className="flex items-center gap-3 text-sm uppercase py-3 px-4 font-bold rounded-xl transition-all duration-200 text-white hover:bg-blue-800/80 dark:hover:bg-gray-700">
              <FiCalendar className="w-5 h-5" />
              Planejamento
            </Link>
            <Link href="/dashboard/faturas" className="flex items-center gap-3 text-sm uppercase py-3 px-4 font-bold rounded-xl transition-all duration-200 text-white hover:bg-blue-800/80 dark:hover:bg-gray-700">
