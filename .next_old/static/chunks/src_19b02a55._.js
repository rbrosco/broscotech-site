...
"[project]/src/app/dev/ia-monitor/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function IAMonitorPage() {
    ...
    const loadSessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "IAMonitorPage.useCallback[loadSessions]": async ()=>{
            try {
                ...
                if (res.ok) {
                    ...
                    var _p_sessions;
                    setSessions((_p_sessions = p.sessions) !== null && _p_sessions !== void 0 ? _p_sessions : []);
                }
            } catch (e) {}
        }
    }["IAMonitorPage.useCallback[loadSessions]"], []);
    const ensureDemoSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "IAMonitorPage.useCallback[ensureDemoSession]": async ()=>{
            ...
            try {
                ...
                if (!projectId) {
                    ...
                    if (createProject.ok) {
                        var _projectPayload_project;
                        const projectPayload = await createProject.json();
                        var _projectPayload_project_id;
                        projectId = (_projectPayload_project_id = (_projectPayload_project = projectPayload.project) === null || _projectPayload_project === void 0 ? void 0 : _projectPayload_project.id) !== null && _projectPayload_project_id !== void 0 ? _projectPayload_project_id : null;
                    }
                }
                if (!projectId) return;
                ...
                if (createSession.ok) {
                    ...
                    if (sessionPayload.session) {
                        setSessions({
                            "IAMonitorPage.useCallback[ensureDemoSession]": (prev)=>[
                                    sessionPayload.session,
                                    ...prev
                                ]
                        }["IAMonitorPage.useCallback[ensureDemoSession]"]);
    ...
    const loadMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "IAMonitorPage.useCallback[loadMessages]": async ()=>{
            if (!selected) {
                setMessages([]);
                return;
            }
    ...
    }["IAMonitorPage.useCallback[loadMessages]"], [
        selected
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IAMonitorPage.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IAMonitorPage.useEffect": ()=>{
            ...
            const interval = setInterval({
                "IAMonitorPage.useEffect.interval": ()=>{
                    fetch("/api/iaagent/sessions/".concat(selected.id, "/messages"), {
                        credentials: 'include'
                    }).then({
                        "IAMonitorPage.useEffect.interval": (res)=>res.json()
                    }["IAMonitorPage.useEffect.interval"]).then({
                        "IAMonitorPage.useEffect.interval": (p)=>{
                            var _p_messages;
                            return setMessages((_p_messages = p.messages) !== null && _p_messages !== void 0 ? _p_messages : []);
                        }
                    }["IAMonitorPage.useEffect.interval"]).catch({
                        "IAMonitorPage.useEffect.interval": ()=>{}
                    }["IAMonitorPage.useEffect.interval"]);
                }
            }["IAMonitorPage.useEffect.interval"], 5000);
            return ({
                "IAMonitorPage.useEffect": ()=>clearInterval(interval)
            })["IAMonitorPage.useEffect"];
        }
    }["IAMonitorPage.useEffect"], [
        selected
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: sessions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: "w-full text-left px-4 py-3.5 rounded-2xl mb-2 transition-all duration-300 border ".concat(isSelected ? 'bg-amber-50 dark:bg-amber-500/10 border-amber-200 dark:border-amber-500/20 shadow-[0_0_15px_rgba(245,158,11,0.05)]' : 'bg-transparent border-transparent hover:bg-slate-100 dark:hover:bg-white/5 hover:border-slate-200 dark:hover:border-white/5'),
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-3",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fi$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FiUser"], {
                                                                className: "w-4 h-4 shrink-0 transition-colors ".concat(isSelected ? 'text-amber-600 dark:text-amber-400' : 'text-slate-400 dark:text-slate-600')
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/dev/ia-monitor/page.tsx",
                                                                lineNumber: 180,
                                                                columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-[11px] font-medium mt-1 pl-7 transition-colors ".concat(isSelected ? 'text-amber-600/80 dark:text-amber-400/60' : 'text-slate-500 dark:text-slate-600'),
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    loadingMsgs ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex gap-4 max-w-3xl ".concat(isAgent ? 'ml-auto flex-row-reverse' : ''),
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "w-10 h-10 rounded-2xl shrink-0 flex items-center justify-center mt-1 border shadow-sm ".concat(!isAgent ? 'bg-indigo-50 dark:bg-indigo-500/10 border-indigo-200 dark:border-indigo-500/20' : 'bg-cyan-50 dark:bg-cyan-500/10 border-cyan-200 dark:border-cyan-500/20'),
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: "text-xs font-medium mt-2 text-slate-400 dark:text-slate-500 ".concat(!isAgent ? 'ml-2' : 'mr-2 text-right'),
                                                                            children: [
...
_s(IAMonitorPage, "UMbRi8egtaqW1e3D1O+ezt0y/Gs=");
_c = IAMonitorPage;
var _c;
__turbopack_context__.k.register(_c, "IAMonitorPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_19b02a55._.js.map