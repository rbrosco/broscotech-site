...
ALTER TABLE kanban_cards ADD COLUMN IF NOT EXISTS assignee_id BIGINT REFERENCES users(id);
ALTER TABLE kanban_cards ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT now();
