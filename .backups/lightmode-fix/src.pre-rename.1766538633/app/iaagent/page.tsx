            ...
            <div className="lg:col-span-1">
              <div className="rounded-3xl bg-white border border-slate-200 dark:bg-black/10 dark:border-white/15 p-5 text-slate-900 dark:text-white shadow-sm">
                ...
                <div className="mt-5 flex gap-2">
                  <a
                    href="/register"
                    className="flex-1 inline-flex items-center justify-center rounded-xl bg-indigo-600 text-slate-900 dark:text-white px-4 py-2.5 font-semibold hover:bg-indigo-700 transition-shadow shadow"
                  >
                    Cadastrar
                  </a>
                  <button
                ...
                >
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 rounded-xl bg-slate-50 dark:bg-black/10 border border-slate-200 dark:border-white/15 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-900 dark:text-white/50 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-300"
                    />
                    <button
                      type="submit"
                      disabled={!canSend}
                      className="rounded-xl bg-indigo-600 text-slate-900 dark:text-white px-5 py-3 font-semibold hover:bg-indigo-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Enviar
                    </button>
                  </div>
